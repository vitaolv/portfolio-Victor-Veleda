...
export function ButtonToSeeDeploy({ pageLink }: ButtonToSeeDeployTypes) {
    ...
    return (
        <button
            className="flex items-center gap-2 w-36 text-center justify-center text-gray-900 font-semibold bg-gradient-to-r to-green-700 from-turquoise-200 rounded-lg"
            type="button"
