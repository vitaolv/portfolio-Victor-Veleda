        ...
        <div>
            {MyCompetencies.map((category) => (
                <div key={category.id} className="max-w-md mx-auto p-4">
                    ...
                    <div data-testid="cardCompetencies" className="border-green-700 bg-gray-500 bg-opacity-20 border-2 shadow-gradient-green-blue shadow-green-700 p-10 rounded-lg md:w-96 w-auto text-center md:text-left">
