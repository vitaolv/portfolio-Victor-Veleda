export function Hero() {
  return (
    <div className="m-0 md:pl-20 md:pr-20 mx-auto items-center w-10/12">
      ...
      <div className="flex flex-col justify-left items-left text-left gap-3 max-w-screen-md">
        ...
        <div
          className="mx-auto mt-5 flex max-w-screen-md flex-col gap-3
                ...
                p-7 shadow-gradient-green-blue shadow-green-200"
        >
          <p className="m-1 font-alt text-xl text-md text-green-700 md:text-left">
