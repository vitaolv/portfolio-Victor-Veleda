export const aboutMeParagraph = [
    {
        id: 1, text: `Em minha jornada intergaláctica, explorei desde linguagens de baixo nível, como C e Assembly, e na minha busca por 
                        conhecimento, explorei galáxias de Java, Python e finalmente aterrissando no terreno fértil de JavaScript e TypeScript.`
    },

    {
        id: 2, text: `Quando não estou explorando o espaço, gosto de jogar no computador, simulando missões e batalhas interestelares. 
    ...
    {
        id: 3, text: `Sou louco por café, que é o meu combustível para navegar pelo espaço digital. Tenho uma afinidade especial por 
                        resolver problemas, que são como enigmas espaciais que desafiam a minha lógica e criatividade. 
